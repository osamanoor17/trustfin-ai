...
[![Status: Phase 0 — Foundation](https://img.shields.io/badge/Status-Phase%200%20%E2%80%94%20Foundation-informational.svg)]()
...
>
> The project is currently in its architectural foundation phase. The current codebase establishes the lightweight software scaffolding, API routing, configuration management, research questions, methodology outline, and testing baseline.
> 
> *RAG pipelines, language model integrations, vector databases, and dense retrieval models are intentionally deferred to subsequent research phases to preserve a lightweight local environment.*
...
|---|---|---|---|
| **Phase 0 — Foundation** | Project architecture, API base, config, research questions, methodology scaffolding | **CURRENT** | Local Machine |
| **Phase 1 — Data Collection & Corpus Preparation** | Multilingual financial document acquisition, parsing, OCR, and benchmark dataset curation | Planned | Local / Scripts |
